sap.ui.define([
	...
	return BaseController.extend("zorder.request.zorderrequest.controller.DialogApprob", {
	// return BaseController.extend("GASS.zcashclose.controller.DialogCloseCash", {
		constructor: function(oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "zorder.request.zorderrequest.view.DialogApprob", this);
			this._bInit = false;
		},
