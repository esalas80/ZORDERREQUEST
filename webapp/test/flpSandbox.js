		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zorderrequestzorderrequest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zorderrequestzorderrequest-display": {
								"semanticObject": "zorderrequestzorderrequest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zorder.request.zorderrequest",
									"url": sap.ui.require.toUrl("zorder/request/zorderrequest")
								}
							}
						}
					}
